    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 pb-28">
        ...
        >
          ...
          />
          <div className="fredoka text-2xl text-white">Dr Wahyuningsih, M.Pd.</div>
          <div className="text-purple-200 text-sm font-bold mt-1">Dosen PGSD</div>
          <div className="flex justify-center gap-3 mt-4 flex-wrap">
            {['📍 Yogyakarta', '🎓 S2 PGSD', '⭐ 10 Tahun Mengajar'].map(t => (
